...
DOWNLOADED_DATASET_PATH = './rockpaperscissors_raw'

MODEL_TYPE = 'yolo12m.pt'
EPOCHS = 2
IMGSZ = 416
BATCH = 16
OPTIMIZER = 'SGD'
...
YOLO_DATASET = './rockpaperscissors'

TEST_IMAGES = ["20220216_222607_jpg.rf.1483f40dac6a642b5bad42a24beeb52a.jpg", "egohands-public-1620849869759_png_jpg.rf.c537eb75df29be09ebea80d01e0b4c76.jpg"] 
...
def train_yolo_model(num_classes, class_names, data_yaml_path, device):
    ...
    last_weights = f"D:/University/4kurs/OIIS/lab3/my/runs/detect/{MODEL_NAME}/weights/last.pt"
    best_weights = f"D:/University/4kurs/OIIS/lab3/my/runs/detect/{MODEL_NAME}/weights/best.pt"

    device_param = 0 if str(device).startswith('cuda') else 'cpu'
